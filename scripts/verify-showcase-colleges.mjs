...
await shot("http://localhost:3001/showcase", "show-d", { width: 1440, height: 900 });
await shot("http://localhost:3001/colleges", "coll-d", { width: 1440, height: 900 });
await shot("http://localhost:3001/colleges", "coll-m", { width: 390, height: 844 });
await browser.close();
console.log("done");
